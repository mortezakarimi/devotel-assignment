...
export class InitialMigration1754646268535 implements MigrationInterface {
  name = 'InitialMigration1754646268535';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "jobs" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "is_remote" boolean NOT NULL DEFAULT false, "job_type" "public"."jobs_job_type_enum", "experience_years" smallint, "posted_date" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "company_id" integer, "provider_name" character varying NOT NULL, "provider_job_id" character varying NOT NULL, "location_city" character varying, "location_state" character varying, "location_country" character varying, "salary_min" integer, "salary_max" integer, "salary_currency" character varying(10), CONSTRAINT "PK_cf0a6c42b72fcc7f7c237def345" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_d1534856e72e8383029ec7fb08" ON "jobs" ("location_country") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "job_skills"
          ADD CONSTRAINT "FK_7c0a3c52e77f9d9d839fdbb14b6" FOREIGN KEY ("skill_id") REFERENCES "skills" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d1534856e72e8383029ec7fb08"`,
    );
    await queryRunner.query(
